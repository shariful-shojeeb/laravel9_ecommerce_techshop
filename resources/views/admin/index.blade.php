              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3">
                      <div class="product-box border">
                         <img src="{{URL::asset('public/admin')}}/assets/images/products/07.png" alt="">
                      </div>
                      <div class="product-info">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3">
                      <div class="product-box border">
                         <img src="{{URL::asset('public/admin')}}/assets/images/products/17.png" alt="">
                      </div>
                      <div class="product-info">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3">
                      <div class="product-box border">
                         <img src="{{URL::asset('public/admin')}}/assets/images/products/04.png" alt="">
                      </div>
                      <div class="product-info">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3">
                      <div class="product-box border">
                         <img src="{{URL::asset('public/admin')}}/assets/images/products/10.png" alt="">
                      </div>
                      <div class="product-info">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3">
                      <div class="product-box border">
                         <img src="{{URL::asset('public/admin')}}/assets/images/products/12.png" alt="">
                      </div>
                      <div class="product-info">
